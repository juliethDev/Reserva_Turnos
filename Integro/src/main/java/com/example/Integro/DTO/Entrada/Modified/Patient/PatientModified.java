...
import com.example.Integro.DTO.Entrada.Patient.AddressEntrance;
...
public class PatientModified {
    @NotNull(message = "Debe proveerse el id del Patient que se desea modificar")
    private Long id;
    ...
    public PatientModified(Long id, String name, String lastName, int dni, LocalDate entryDate, AddressEntrance addressEntrance) {
        this.id = id;
        this.name = name;
